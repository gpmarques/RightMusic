...
//        MusicDAO.getSingleton().createMusic("Big Me 1", name: "Big Me", chords: cifra, genre: "Rock", tone: tom, lyrics: letra)
//        print(tom)
//        print(letra)
//        print(cifra)
//        pegaCifraMusica("https://www.cifraclub.com.br/jack-johnson/breakdown/")
//        MusicDAO.getSingleton().createMusic("Breakdown 2", name: "Breakdown", chords: cifra, genre: "Alternativo", tone: tom, lyrics: letra)
//        print(tom)
//        print(letra)
//        print(cifra)
//        pegaCifraMusica("https://www.cifraclub.com.br/foo-fighters/learn-to-fly-acoustic-version/")
//        MusicDAO.getSingleton().createMusic("Learn To Fly", name: "Learn To Fly", chords: cifra, genre: "Rock", tone: tom, lyrics: letra)
//        print(tom)
//        print(letra)
//        print(cifra)
